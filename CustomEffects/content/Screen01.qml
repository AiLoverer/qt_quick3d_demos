...
Rectangle {
    ...
    View3D {
        ...
        Effect {
            ...
            property TextureInput tex: TextureInput {
                id: qtLogo
                texture: Texture { source: "images/qt_logo_rect.png" }
            }
            passes: Pass {
                shaders: Shader {
                    id: fs1
        ...
        Effect {
            ...
            Shader {
                id: vs2
                stage: Shader.Vertex
                shader: "shaders/effect2.vert"
            }
            Shader {
                id: fs2
                stage: Shader.Fragment
                shader: "shaders/effect2.frag"
            }
            passes: Pass {
                shaders: [ vs2, fs2 ]
            }
    ...
    Item {
        ...
        DefaultMaterial { objectName: ""; diffuseMap: checkers }

        DefaultMaterial { objectName: ""; diffuseColor: "green" }

        DefaultMaterial { objectName: ""; diffuseColor: "#808000" }

        DefaultMaterial { objectName: ""; diffuseColor: "gray" }
    }
}
